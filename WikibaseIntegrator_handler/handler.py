...
login_instance = wbi_login.OAuth1(consumer_token='f89531493fffb686fd6c08d2f13060b8', consumer_secret='3c5605812084a82738b74244ffd8cfcbb8e7d664',
                                  ...
                                  mediawiki_api_url="http://147.231.55.155/w/api.php", mediawiki_index_url="http://147.231.55.155/w/api.php")

#login_instance = wbi_login.Login(user='Admin@small_bot', password='2c7r9a81orn77qfa3mtuke6thpta4ekc', mediawiki_api_url="http://147.231.55.155/w/api.php")
configure_wb()
wbi = WikibaseIntegrator(login_instance)
