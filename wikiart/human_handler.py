...
necessary_properties = {'given_name' : 'P61', 'family_name' : 'P60', 'sec_fam_name' : 'P62', 'pseudonym' : 'P58' ,
                        ...
                        'sex' : 'P8', "instance" : "P1", 'img_addr': 'P69', 'wikiart_id': 'P74',
                         'wikiart_url': 'P73', 'active_years_start': 'P75', 'active_yars_end': 'P76'}
...
class Human:
    ...
    def AddToExisting(self, data: dict[str, str]):
        print()


h = Human()

print(h.Exists("Erol Akyavaş"))
